...
from app.services.apify_client import fetch_and_store_latest, fetch_and_store_multi_source
...
async def manual_fetch(request: Request, db: Session = Depends(get_db)):
    ...
    """
    # Fetch from both Autotrader and Cars.com actors with 5 most recent runs
